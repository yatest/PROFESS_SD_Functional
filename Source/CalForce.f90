...
!------------------------------------------------------------------------------
  ...
  !USE Fourier, ONLY: FFT !VVK commented
#ifdef __FFTW2 !--> VVK
...
#ifdef __FFTW2 !--> VVK
    forces(:,:,3) = IonElectronForcesSpline(FFT_2(SUM(rhoR,4)), cell%ionTable, cell%elementTable, cell%cellReal)
#else
...
!--> VVK commented and replaced
#ifdef __FFTW2 !--> VVK
    forces(:,:,3) = IonElectronForces(FFT_2(SUM(rhoR,4)), cell%ionTable, cell%elementTable, cell%cellReal)
#else
