...
#ifdef __FFTW2 !--> VVK
!!! WHY FFT_2 is not working here ???
   jPotentialRecip = FFT_2(rhoRecip) / qTable**2
...
!--> VVK commented and replaced
#ifdef __FFTW2 !--> VVK
   SqrtPreconditioner(:,:,:,1) = FFT_2(jPotentialRecip)
#else
...
!--> VVK commented and replaced
#ifdef __FFTW2 !--> VVK
   jPotentialRecip = FFT_2(rhoReal) ! Store rhoRecip temporarily to save memory
#else
...
!--> VVK commented and replaced
#ifdef __FFTW2 !--> VVK
   potential = FFT_2(jPotentialRecip)
#else
