...
!--> VVK
  INTEGER, PARAMETER :: scratchUnit = 13      ! scratch file
  !INTEGER            :: logUnit = 8
  INTEGER            :: logUnit = 6
  !INTEGER            :: logUnit = 61
  !INTEGER, PARAMETER :: logUnit = 61 !6 !61       ! log !VVK, output to the standard
                                              ! unit 6 and some other output 
                                              ! are redirected to logUnit 
                                              ! 01 MAY 2015: at the moment logUnit = 6 
                                              ! and we do not open logUnit file
!<-- VVK
