...
FUNCTION BSplineProduct_old(array, squareProduct)
!------------------------------------------------------------------------------
...
!------------------------------------------------------------------------------
  ...
  IF (square) THEN
    DO i = 1, SIZE(array,1)
      DO j = 1, SIZE(array,2)
        DO k = 1, SIZE(array,3)
          BSplineProduct_old(i,j,k) = array(i,j,k) * &
                                  bSpline1(i) * CONJG(bSpline1(i)) * &
                                  bSpline2(j) * CONJG(bSpline2(j)) * &
                                  bSpline3(k) * CONJG(bSpline3(k))
        END DO
...
END FUNCTION BSplineProduct_old
